...
// Code taken from: http://www.geeksforgeeks.org/lowest-common-ancestor-binary-tree-set-1/
...
/* This function return pointer to LCA of two given values n1 and n2 
...
function findLCA(root, n1, n2) {
    ...
    if ( (v[0] && v[1]) || (v[0] && find(lca, n2)) || (v[1] &&
        find(lca, n1)) ) {
        return lca;
    } else { 
       // Else return None
